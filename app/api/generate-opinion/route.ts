...
- 금지어가 사용되면 템플릿을 무시하고 "비속어는 헌법재판소에 제출하기 어려워요 :(" 출력 (정확한 텍스트로 출력)
    - 금지어: "탄핵 반대", "운지", "부엉이", '"노무현, 문재인"에 대한 부정적 표현, 교묘하게 비꼬는 표현'
- 템플릿을 따른 결과물을 보고 맥락이 벗어나는 경우 템플릿을 무시하고 "그런 장난 별로 재미없어요 :(" 출력 (정확한 텍스트로 출력)
- !!한자 사용 금지, 반드시 한글 혹은 숫자로 작성 (히라가나 사용금지)!!
---
[템플릿]
...
(적당한 마무리 문구를 3개 정도 생각해서 적절한 변형을 가하고 합쳐서 작성. 예시와는 다르게 변형
  예시: '국민들의 불안과 걱정을 헤아리시고', '하루 빨리 탄핵을 인용하여', '법과 정의의 이름으로 민주주의를 바로 세워주시길 강력히 촉구합니다.' 
)
---
[거주지] (구/동 단위까지)
${address}
